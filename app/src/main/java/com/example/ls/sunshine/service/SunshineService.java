package com.example.ls.sunshine.service;
...
import com.example.ls.sunshine.BuildConfig;
...
/**
 * Created by LS on 19.11.2015.
 */
public class SunshineService extends IntentService {


    private final String LOG_TAG = SunshineService.class.getSimpleName();
    public final static String LOCATION_AREA_EXTRA = "params";
...
///        final String OWM_DESCRIPTION = "main";
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                inserted = this.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, contentValuesArray);
            }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String locationQuery = intent.getStringExtra(LOCATION_AREA_EXTRA);
    ...
    public static class AlarmReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            sendIntent.putExtra(LOCATION_AREA_EXTRA,
                    intent.getStringExtra(LOCATION_AREA_EXTRA));
